        ...
        <Box sx={{ p: 5 }}>
          ...
          <StyledPaper>
            <Typography align="left">
              Tältä sivulta löydät yleistä tietoa luomastamme projektista.
            </Typography>
            <Typography align="left">
              Kirja-arkisto sovelluksella voit luoda omia kokoelmia ja muokata
              niitä.
            </Typography>
            <Typography align="left">
              Rekisteröityminen ja kirjautuminen on pakollista, jos haluat luoda
              tai muokata omia kokoelmia.
            </Typography>
            <Typography align="left">
              Mahdolliset ilmoitukset ongelmista voi lähettää Scrum Masterille
              sähköpostitse.
            </Typography>
          </StyledPaper>
          <StyledPaper>
            <Typography variant="h5" sx={{ mb: 2 }}>
              TestoSonnit Oy:n jäsenet
            </Typography>
          ...
          <StyledPaper>
            ...
            <Typography align="left">
              ...
              <a href="mailto:ScrumMaster@hotmail.com">
                ScrumMaster@hotmail.com
              </a>
            </Typography>
            <Typography align="left">
              Yhteydenotot puhelimitse numeroon:{" "}
              <a href="tel:04542071551">04542071551</a>
            </Typography>
